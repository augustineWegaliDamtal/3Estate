  ...
  return (
    <div className='bg-slate-100 h-screen '>
      ...
      <form className='flex flex-col  mx-auto max-w-sm gap-4'>
        ...
        <input type='text' className='border border-gray-300 p-2 rounded-sm bg-white outline-0'id='username' placeholder='username'/>
        <input type='text' className='border border-gray-300 p-2 rounded-sm bg-white outline-0'id='email' placeholder='email'/>
