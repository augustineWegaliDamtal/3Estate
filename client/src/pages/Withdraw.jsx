 ...
 day:currentDate.getDate(),
  ...
  return (
    <div className='bg-gray-100   '>
      <h1 className='text-center font-bold text-slate-700 uppercase'>Withdrawal Form</h1>
      <div>
      
        <form onSubmit={handleSubmit} className=' mx-auto max-w-sm flex flex-col gap-4 bg-red-700 p-6'>
